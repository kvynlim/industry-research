...
33. `50-cloud-fleet/data-platform/data-engine-from-bags.md` — Detailed bag processing code for airside dataset creation.
34. `50-cloud-fleet/data-platform/data-engines-datasets.md` — Survey of AV datasets and data engine architectures.
35. `50-cloud-fleet/data-platform/3d-annotation-tools.md` — Comprehensive annotation tool comparison for airside objects.
36. `40-runtime-systems/ml-deployment/production-ml-deployment.md` — TensorRT deployment, model monitoring, A/B testing.
37. `50-cloud-fleet/ota/ota-fleet-management.md` — OTA update architectures and fleet management platforms.
38. `60-safety-validation/verification-validation/shadow-mode.md` — Shadow mode architecture for progressive AI deployment.
39. `50-cloud-fleet/fleet-management/fleet-management-dispatch.md` — Fleet management and dispatch systems.
