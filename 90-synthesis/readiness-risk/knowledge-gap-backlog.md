...
| Track | Files promoted |
|---|---|
| Learned LiDAR denoising/removal | [LIORNet](../../30-autonomy-stack/perception/methods/liornet.md), [LiSnowNet](../../30-autonomy-stack/perception/methods/lisnownet.md), [SLiDE](../../30-autonomy-stack/perception/methods/slide-lidar-desnowing.md), [TripleMixer](../../30-autonomy-stack/perception/methods/triplemixer.md), [3D-KNN Blind-Spot Desnowing](../../30-autonomy-stack/perception/methods/3d-knn-blind-spot-desnowing.md), [3D-OutDet](../../30-autonomy-stack/perception/methods/3d-outdet.md), [AdverseNet](../../30-autonomy-stack/perception/methods/adversenet.md), and [DenoiseCP-Net](../../30-autonomy-stack/perception/methods/denoisecp-net.md). |
| Broad removal mechanics | [Classical LiDAR Outlier Removal](../../30-autonomy-stack/perception/methods/classical-lidar-outlier-removal.md), [LiDAR Weather Artifact Removal](../../30-autonomy-stack/perception/methods/lidar-weather-artifact-removal.md), [LiDAR Artifact Removal Techniques](../../30-autonomy-stack/perception/overview/lidar-artifact-removal-techniques.md), and [LiDAR Ghost and Multipath Artifacts](../../20-av-platform/sensors/lidar-ghost-multipath-artifacts.md). |
| Weather benchmarks | [Weather Robustness Datasets](../../30-autonomy-stack/perception/datasets-benchmarks/weather-robustness-datasets.md), [WADS](../../30-autonomy-stack/perception/datasets-benchmarks/wads-winter-adverse-driving-dataset.md), [CADC/CADC+](../../30-autonomy-stack/perception/datasets-benchmarks/cadc-cadc-plus.md), [SemanticSTF](../../30-autonomy-stack/perception/datasets-benchmarks/semanticstf.md), [REHEARSE-3D](../../30-autonomy-stack/perception/datasets-benchmarks/rehearse-3d.md), [RainSense](../../30-autonomy-stack/perception/datasets-benchmarks/rainsense.md), [SemanticSpray](../../30-autonomy-stack/perception/datasets-benchmarks/semantic-spray.md), [RADIATE](../../30-autonomy-stack/perception/datasets-benchmarks/radiate.md), and [Seeing Through Fog/DENSE](../../30-autonomy-stack/perception/datasets-benchmarks/seeing-through-fog-dense.md). |
| Safety and map cleaning | [LiDAR Artifact Removal Validation](../../60-safety-validation/verification-validation/robustness/lidar-artifact-removal-validation.md), [ERASOR](../../30-autonomy-stack/localization-mapping/slam-methods/erasor.md), [Removert](../../30-autonomy-stack/localization-mapping/slam-methods/removert.md), and [LiDAR Map Cleaning and Dynamic Removal](../../30-autonomy-stack/localization-mapping/slam-methods/lidar-map-cleaning-dynamic-removal.md). |
| Machine-learning foundations | [Machine Learning Foundations Overview](../../10-knowledge-base/machine-learning/overview.md), perceptron/logistic/MLP/backprop/optimization primers, CNN/RNN sequence-model primers, transformer and vision-transformer first principles, self-supervised learning, foundation-model training, [JEPA latent predictive learning](../../10-knowledge-base/machine-learning/jepa-latent-predictive-learning.md), and [world-model first principles](../../10-knowledge-base/machine-learning/world-models-first-principles.md). |
...
| Track | Files promoted |
|---|---|
| Dynamic/static map cleaning | [MapCleaner](../../30-autonomy-stack/localization-mapping/slam-methods/mapcleaner.md), [ERASOR++](../../30-autonomy-stack/localization-mapping/slam-methods/erasor-plus-plus.md), [4dNDF](../../30-autonomy-stack/localization-mapping/slam-methods/4dndf.md), [FreeDOM](../../30-autonomy-stack/localization-mapping/slam-methods/freedom-dynamic-object-removal.md), [STATIC-LIO Dynamic-Point Removal](../../30-autonomy-stack/localization-mapping/slam-methods/static-lio-dynamic-points-removal.md), and [Dynamic Map Cleaning Benchmarks](../../30-autonomy-stack/localization-mapping/slam-methods/dynamic-map-cleaning-benchmarks.md). |
| Scene-flow and motion/static evidence | [MotionSeg3D](../../30-autonomy-stack/perception/methods/motionseg3d.md), [MambaMOS](../../30-autonomy-stack/perception/methods/mambamos.md), [Neural Scene Flow Priors](../../30-autonomy-stack/perception/methods/neural-scene-flow-priors.md), [Scene Flow for Dynamic Object Removal](../../30-autonomy-stack/world-models/scene-flow-for-dynamic-object-removal.md), [Scene-Flow Datasets and Benchmarks](../../30-autonomy-stack/world-models/scene-flow-datasets-benchmarks.md), and [Moving/Static Separation MOS Datasets](../../30-autonomy-stack/perception/datasets-benchmarks/moving-static-separation-mos-datasets.md). |
| Map-change and safety validation | [Moved-Object and Map-Change Datasets](../../30-autonomy-stack/localization-mapping/maps/moved-object-and-map-change-datasets.md), [Occupancy-Flow and 4D Occupancy Benchmarks](../../30-autonomy-stack/perception/datasets-benchmarks/occupancy-flow-and-4d-occupancy-benchmarks.md), and [Airside Dynamic Map-Cleaning Benchmark](../../60-safety-validation/verification-validation/airside-dynamic-map-cleaning-benchmark.md). |
| ML objective/evaluation foundations | [Autoencoders/VAEs](../../10-knowledge-base/machine-learning/autoencoders-vae-and-latent-variable-models-first-principles.md), [Contrastive InfoNCE](../../10-knowledge-base/machine-learning/contrastive-learning-infonsce-first-principles.md), [Masked Modeling](../../10-knowledge-base/machine-learning/masked-modeling-first-principles.md), [Energy-Based Models](../../10-knowledge-base/machine-learning/energy-based-models-first-principles.md), [Tokenization](../../10-knowledge-base/machine-learning/tokenization-and-discretization-first-principles.md), [Positional Encodings](../../10-knowledge-base/machine-learning/positional-encodings-and-coordinate-tokenization-first-principles.md), [S4/Mamba](../../10-knowledge-base/machine-learning/state-space-models-s4-mamba-first-principles.md), [Diffusion/Score/Flow Samplers](../../10-knowledge-base/machine-learning/diffusion-score-flow-samplers-first-principles.md), [Multi-Task Losses](../../10-knowledge-base/machine-learning/multi-task-losses-and-objectives-first-principles.md), [Evaluation/Calibration/Leakage](../../10-knowledge-base/machine-learning/evaluation-calibration-and-data-leakage-first-principles.md), and [World-Model Evaluation](../../10-knowledge-base/machine-learning/world-model-evaluation-and-planning-objectives-first-principles.md). |
