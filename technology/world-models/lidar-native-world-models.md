...
| Document | Relevance |
|----------|-----------|
| `technology/world-models/overview.md` | Camera-centric world models overview |
| `technology/world-models/occupancy-world-models.md` | Detailed occupancy forecasting methods |
| `technology/world-models/occupancy-deployment-orin.md` | Orin deployment specifics |
| `technology/world-models/occworld-implementation.md` | OccWorld hands-on setup guide |
| `technology/world-models/tokenized-and-jepa.md` | VQ-VAE tokenization and JEPA theory |
| `technology/perception/lidar-foundation-models.md` | LiDAR pre-training and backbone models |
| `technology/world-models/cutting-edge-2026.md` | Latest 2025-2026 developments |
| `synthesis/design-spec.md` | Simplex architecture and world model integration |
| `synthesis/poc-proposals.md` | POC cost estimates |
| `technology/localization/lidar-slam-algorithms.md` | LiDAR SLAM for map building |
