...
**Recommendation**: IL first (BC bootstrap), then RL fine-tuning in simulation (see `technology/planning/reinforcement-learning-driving-policy.md`).
...
### Internal Repository
- `technology/planning/reinforcement-learning-driving-policy.md` — BC→offline RL→online RL pipeline, RL post-IL
- `technology/planning/frenet-augmentation.md` — Frenet planner cost function structure
- `technology/planning/safety-critical-planning-cbf.md` — CBF safety filter for post-processing
...
- `technology/planning/neural-motion-planning.md` — Learned planning approaches
