...
DiffusionDrive (documented in `technology/planning/diffusion-trajectory-planning.md`) generates trajectory samples via truncated diffusion (5 steps, 45 ms on Orin). CBF integration can happen at two levels:
