...
class CausalAugmentedFrenetCost:
    ...
    See also: technology/planning/frenet-planner-augmentation.md
    """
...
**Cross-reference:** See `technology/planning/frenet-planner-augmentation.md` for the full Frenet cost function and integration architecture.
