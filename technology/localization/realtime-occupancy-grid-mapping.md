...
nvblox is covered in detail in `technology/world-models/occupancy-deployment-orin.md` Section 6. This document focuses on the broader occupancy grid architecture, where nvblox is one implementation option.
...
| Topic | Document |
|-------|----------|
| Neural occupancy on Orin (FlashOcc, nvblox) | `technology/world-models/occupancy-deployment-orin.md` |
| Occupancy prediction world models | `technology/world-models/occupancy-world-models.md` |
| Occupancy flow and 4D scene understanding | `technology/world-models/occupancy-flow-4d-scenes.md` |
| LiDAR SLAM algorithms | `technology/localization/lidar-slam-algorithms.md` |
| 3DGS for perception and mapping | `technology/perception/gaussian-splatting-driving.md` |
...
| HD map standards for airside | `technology/localization/hd-map-standards-airside.md` |
