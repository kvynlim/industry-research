...
- **SLAM algorithms** (`lidar-slam-algorithms.md`): KISS-ICP, LIO-SAM, FAST-LIO2
...
For multi-session map merging, loop closures are critical for eliminating drift. The pipeline from `lidar-place-recognition-relocalization.md` applies:
...
- `lidar-slam-algorithms.md` — SLAM algorithm details (KISS-ICP, LIO-SAM, FAST-LIO2)
...
- `lidar-place-recognition-relocalization.md` — Loop closure and place recognition
- `robust-state-estimation-multi-sensor.md` — ESKF, GTSAM factor graph
