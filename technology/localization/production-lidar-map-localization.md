...
**Potential for Aurrigo**: Reduce map tile sizes from 15-25 MB to 1-5 MB, enabling faster OTA distribution (see `map-tile-versioning-distribution.md`). Research-stage; not recommended for initial deployment.
