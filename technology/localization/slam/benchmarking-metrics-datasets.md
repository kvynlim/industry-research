...
|---|---|---|
| LiDAR method details | [LiDAR SLAM Algorithms](../lidar-slam-algorithms.md) | Provides method-specific performance notes for [KISS-ICP](kiss-icp.md), [LIO-SAM](lio-sam.md), [FAST-LIO2](fast-lio-fast-lio2.md), Faster-LIO-style voxel LIO, [CT-ICP](ct-icp.md), and [Point-LIO](point-lio.md). |
| Production localization metrics | [Production LiDAR Map Localization](../production-lidar-map-localization.md) | Adds scan-to-map fitness, degeneracy, covariance, and runtime acceptance gates. |
