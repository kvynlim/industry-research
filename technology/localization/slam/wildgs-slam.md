...
Related docs: [Gaussian Splatting for Driving](../../perception/gaussian-splatting-driving.md), [ORB-SLAM2/ORB-SLAM3](orb-slam2-orb-slam3.md), [loop closure and place recognition](loop-closure-place-recognition.md), and [SLAM benchmarking](benchmarking-metrics-datasets.md).
