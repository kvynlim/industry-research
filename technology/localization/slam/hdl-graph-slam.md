...
For an AV program, HDL Graph SLAM is a useful reference implementation of graph constraints and offline mapping, while [production LiDAR map localization](../production-lidar-map-localization.md) should define the runtime scan-to-map module.
...
- Convert the final point cloud into production map layers through the [map construction pipeline](../map-construction-pipeline.md).
