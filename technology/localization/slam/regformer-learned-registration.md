...
| Production runtime localization | [Production LiDAR Map Localization](../production-lidar-map-localization.md) | Pairwise learned registration does not replace bounded scan-to-map localization in a validated map. |
| Dense/neural map context | [Gaussian Splatting for Driving](../../perception/gaussian-splatting-driving.md) | Learned registration and Gaussian maps are separate research lines that may later meet in dense map QA. |
