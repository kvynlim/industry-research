...
|---|---|---|
| Gaussian perception and mapping | [Gaussian Splatting for Driving](../../perception/gaussian-splatting-driving.md) | Broader AV-oriented discussion of Gaussian scene representations. |
...
| Runtime localization | [Production LiDAR Map Localization](../production-lidar-map-localization.md) | SplaTAM dense maps are not a certified localization replacement. |
| Map construction | [Map Construction Pipeline](../map-construction-pipeline.md) | Gaussian outputs need map QA, georeferencing, and lifecycle management before operational use. |
