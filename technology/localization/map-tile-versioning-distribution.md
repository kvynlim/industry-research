...
13. `technology/localization/map-construction-pipeline.md` -- Produces the initial map package that this system tiles and distributes.
14. `technology/localization/hd-map-change-detection-maintenance.md` -- Detects changes that trigger the updates distributed by this system.
15. `technology/localization/hd-map-standards-airside.md` -- Defines Lanelet2/AMDB formats used in tile layers.
...
18. `technology/localization/semantic-mapping-learned-priors.md` -- Defines the 7-layer map architecture referenced in tile content design.
19. `technology/localization/lidar-place-recognition-relocalization.md` -- Place recognition features stored in tile feature layer for relocalization.
