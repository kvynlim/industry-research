...
This extends the fleet-based map maintenance described in [hd-map-change-detection-maintenance.md](hd-map-change-detection-maintenance.md) with real-time inter-vehicle alignment rather than post-hoc batch processing.
