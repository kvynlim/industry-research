...
DINOv2 features contain rich semantic information usable for multiple tasks simultaneously (see `technology/perception/dinov2-foundation-models-driving.md`):
...
Point Transformer v3 (PTv3) provides a unified LiDAR feature extractor (see `technology/perception/lidar-foundation-models.md`):
