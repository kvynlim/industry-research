...
- `technology/vla/vla-for-driving.md` — VLA architectures for driving
- `technology/vla/vlm-scene-understanding.md` — VLM co-pilot for scene understanding
- `technology/vla/vla-distillation-scaling.md` — distilling large VLAs for Orin
- `cross-cutting/embodied-ai-crossover.md` — robotics-to-driving transfer
- `technology/planning/autonomous-docking-precision-positioning.md` — docking algorithms
- `technology/perception/open-vocab-detection.md` — open-vocabulary detection
...
**Key insight:** SpatialVLM would not replace the primary perception pipeline (PointPillars + GTSAM at 10 Hz). It would run as a **spatial reasoning co-pilot** at 1-2 Hz alongside the primary loop, providing higher-order spatial understanding for task planning and anomaly detection — analogous to the VLM co-pilot architecture described in `technology/vla/vlm-scene-understanding.md`.
...
The two-phase docking architecture documented in `technology/planning/autonomous-docking-precision-positioning.md` uses:
...
This follows the pattern documented in `technology/planning/joint-prediction-planning.md` where adding prediction-based costs to existing Frenet candidates captures 70-80% of the benefit at 10% of full implementation cost.
