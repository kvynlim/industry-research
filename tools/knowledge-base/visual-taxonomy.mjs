...
export const PAGE_DIAGRAM_KIND = Object.freeze({
  ...
  '10-knowledge-base/geometry-3d/feed-forward-3d-reconstruction-and-splatting.md': 'tensor-pipeline',
  ...
  '10-knowledge-base/mapping/dynamic-4d-neural-gaussian-reconstruction.md': 'representation-comparison',
