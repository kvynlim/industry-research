...
- `70-operations-domains/airside/operations/airport-data-systems-detailed.md` — API endpoints for NOTAM, AIDX, ACRIS
- `70-operations-domains/airside/operations/turnaround-prediction.md` — Turnaround phase model
- `30-autonomy-stack/localization-mapping/maps/hd-map-standards-airside.md` — AMDB/Lanelet2 for route graphs
- `60-safety-validation/verification-validation/airside-scenario-taxonomy.md` — Scenario catalog including instruction failures
- `30-autonomy-stack/vla-vlm/vlm-scene-understanding.md` — VLM for NOTAM interpretation
- `50-cloud-fleet/fleet-management/fleet-management-dispatch.md` — Fleet dispatch architecture
