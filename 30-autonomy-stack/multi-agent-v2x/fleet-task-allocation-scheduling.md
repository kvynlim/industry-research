...
2. **The problem is tractable at the reference airside AV stack's scale**. With 20-50 vehicles and 200-500 tasks per day, CP-SAT solves to optimality in 10-60 seconds. Even medium hubs (200 vehicles, 3000 tasks) are solvable with decomposition.
