...
|---|---|---|
| Gaussian representation overview | [Gaussian Splatting for Driving](../../perception/overview/gaussian-splatting-driving.md) | Broader AV context for 3D Gaussian Splatting and its limits. |
...
| Production localization | [Production LiDAR Map Localization](../overview/production-lidar-map-localization.md) | Gaussian visual SLAM should not replace validated map-frame localization. |
