...
**Key insight**: We do NOT upload all raw rosbags. The trigger-based collection strategy (see data-flywheel-airside.md) selects ~50 GB/day per vehicle. Even so, a 100-vehicle fleet generates ~6.5 TB/day of cloud-bound data.
...
| Labeling workflows | `data-flywheel-airside.md` | Pipeline orchestration, QA gates |
| Auto-labeling | `data-flywheel-airside.md` | Kubernetes job scheduling, GPU allocation |
| Model training | `data-flywheel-airside.md` | Feature store, experiment tracking |
...
class VehicleDataEgress:
    ...
    # Daily upload budget per vehicle (from data-flywheel-airside.md)
    DAILY_BUDGET_GB = 50
...
- `cross-cutting/fleet-data-pipeline.md` — Vehicle-side data collection and DVC versioning
- `cross-cutting/data-flywheel-airside.md` — Trigger-based collection, active learning, retraining cycle
