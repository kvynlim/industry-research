...
The 10-15% utilization improvement from joint optimization is roughly equivalent to adding 5-7 vehicles to a 50-vehicle fleet --- at zero capital cost. At $80-180K per vehicle (see `fleet-tco-business-case.md`), this represents $400K-1.26M in avoided CAPEX.
...
The charging strategy determines WHEN and HOW MUCH to charge. The battery-charging-infrastructure document (`../../operations/airside/battery-charging-infrastructure.md`) covers the hardware. Here we analyze the scheduling implications.
...
3. **Automatic docking.** Autonomous self-charging (see `../../operations/airside/battery-charging-infrastructure.md`, Section 2.4) eliminates the 2-5 minute human connect/disconnect overhead, making 8-10 minute micro-charges viable.
...
Battery replacement is the second-largest OPEX item for electric GSE after electricity itself (see `fleet-tco-business-case.md`). A 60 kWh LiFePO4 pack costs $7,500-12,000 (2026 prices at $125-200/kWh pack-level). If degradation-unaware scheduling shortens pack life from 6 years to 4 years, the annualized cost increases by 50% --- roughly $2,000/vehicle/year across a 50-vehicle fleet, that is $100K/year in accelerated replacement. The co-optimizer must therefore include degradation as an explicit cost term.
