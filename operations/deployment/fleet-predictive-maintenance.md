...
**Cost of spare vehicles:** Each spare vehicle costs $60K-180K CAPEX (per [fleet-tco-business-case.md](fleet-tco-business-case.md)). Maintaining 3 spare vehicles at $100K each = $300K capital invested in maintenance buffer. Predictive maintenance reduces the required buffer from 3-4 spares to 1-2 spares, freeing $100K-200K in capital.
