...
The Aurrigo Simplex architecture (see [simplex-safety-architecture.md](simplex-safety-architecture.md)) is a natural candidate for ASIL decomposition:
...
3. **Cybersecurity as safety**: The regulation treats cybersecurity vulnerabilities as safety risks. See [cybersecurity-airside-av.md](cybersecurity-airside-av.md) for detailed treatment.
...
See [regulatory-trajectory-deep-dive.md](regulatory-trajectory-deep-dive.md) for detailed timelines and regulatory pathways.
...
29. [Simplex Safety Architecture](simplex-safety-architecture.md) — Dual-stack architecture with safety arbitration
30. [Regulatory Trajectory Deep Dive](regulatory-trajectory-deep-dive.md) — FAA, EASA, ICAO regulatory timeline
31. [Cybersecurity for Airside AVs](cybersecurity-airside-av.md) — Threat models, ISO 21434, defense strategies
32. [Ground Crew and Pedestrian Safety](ground-crew-pedestrian-safety.md) — Ramp accident data, detection challenges
33. [Failure Modes Analysis](failure-modes-analysis.md) — FMEA for airside AV systems
