...
| Aircraft damage | $250K-139M | Per `operations/airside/industry-overview.md` |
...
Static verification and runtime verification (see `operations/safety/runtime-verification-monitoring.md`) are complementary, not competing, approaches. Understanding their respective strengths determines how to allocate verification budget:
...
- Cost: Already implemented (see `operations/safety/runtime-verification-monitoring.md`)
...
This is precisely the defense-in-depth philosophy described in `operations/safety/runtime-verification-monitoring.md` and `operations/safety/simplex-safety-architecture.md`.
...
│    [operations/safety/runtime-verification-monitoring.md]     │
...
│    [operations/safety/simplex-safety-architecture.md]         │
...
While ISO 26262 was written for traditional software (see `operations/safety/functional-safety-software.md`), its principles extend to neural network components:
