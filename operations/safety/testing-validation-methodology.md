...
For airside operations, RSS parameters are adapted (see `simplex-safety-architecture.md` Section 2):
...
- **Safe degradation:** The system should detect input corruption (via OOD detection, see `simplex-safety-architecture.md` Section 3) and enter a degraded operating mode (reduce speed or stop) rather than making dangerous decisions based on corrupted data.
...
**RSS for airside (adapted from `simplex-safety-architecture.md` Section 2):**
...
For the Aurrigo Simplex architecture (see `simplex-safety-architecture.md` Section 4), shadow mode is a natural first step:
...
**Phase gate criteria (aligned with `simplex-safety-architecture.md` Section 4.3):**
...
31. **[certification-guide.md](certification-guide.md)** -- ISO 3691-4, UL 4600, AMLAS, ISO 26262, CE marking, FAA approval process
32. **[simplex-safety-architecture.md](simplex-safety-architecture.md)** -- Dual-stack architecture, RSS for airside, OOD detection, shadow mode logging
...
37. **[../../technology/simulation/digital-twin-airport.md](../../technology/simulation/digital-twin-airport.md)** -- Airport digital twin construction and validation
